...
public class HashTableImpl<Key, Value> implements HashTable<Key, Value> {
    ...
    public Value put(Key k, Value v) {
        ...
        double loadFactor = (double) amountOfPairs / tableSize;
        if (loadFactor > 0.75) {
            resize(tableSize * 2);
        }
    ...
    private void resize(int newSize) {
        HashTableImpl<Key, Value> tempTable = new HashTableImpl<>();
        tempTable.tableSize = newSize;
        tempTable.chainedEntrys = new entry[newSize];
        ...
        this.amountOfPairs = tempTable.amountOfPairs;
        this.chainedEntrys = tempTable.chainedEntrys;
    }
